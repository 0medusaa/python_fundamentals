...
# Bir sınıfın her hangi bir üyesini encapsulation ettiğimiz zaman, ilgili üyeye alt sınıflardan erişemeyiz böylelikle bu üyeyi erişime kapamış oluyoruz. Yani enkapsüle edişmiş bir üye alt sınıflarda değiştirilemeyecektir. Buna bir nevi sınıf dışında erişime yani müdaheleye kapatmak diyebiliriz. Belirli şartlart doğrultusunda bu erişimi dolaylı yollar ile yapabiliyoruz.
